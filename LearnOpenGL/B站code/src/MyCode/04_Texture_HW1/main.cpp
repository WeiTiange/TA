...
//  ---- Texture2----
    ...
    // 创建和编译自定义的shader程序
    Shader customShader("./src/MyCode/04_Texture_HW1/3.3.shader.vert", "./src/MyCode/04_Texture_HW1/3.3.shader.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        customShader.use();
        customShader.setFloat("time", (sin(glfwGetTime()+1.5f)+1.0f) / 2.0);
