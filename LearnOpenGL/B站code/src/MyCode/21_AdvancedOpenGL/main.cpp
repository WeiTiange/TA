...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader Cube01Shader("./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader01.vert", "./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader01.frag");
    Shader Cube02Shader("./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader02.vert", "./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader02.frag");
    Shader Cube03Shader("./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader03.vert", "./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader03.frag");
    Shader Cube04Shader("./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader04.vert", "./src/MyCode/21_AdvancedOpenGL/Shaders/CubeShader04.frag");

    // -----绑定着色器Uniform块-----
    unsigned int UBI_Cube01 = glGetUniformBlockIndex(Cube01Shader.ID, "Matrices");      // UBI = uniform block index
    unsigned int UBI_Cube02 = glGetUniformBlockIndex(Cube02Shader.ID, "Matrices");
    unsigned int UBI_Cube03 = glGetUniformBlockIndex(Cube03Shader.ID, "Matrices");
    unsigned int UBI_Cube04 = glGetUniformBlockIndex(Cube04Shader.ID, "Matrices");
    glUniformBlockBinding(Cube01Shader.ID, UBI_Cube01, 0);
    glUniformBlockBinding(Cube02Shader.ID, UBI_Cube02, 0);
    glUniformBlockBinding(Cube03Shader.ID, UBI_Cube03, 0);
    glUniformBlockBinding(Cube04Shader.ID, UBI_Cube04, 0);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        M = glm::translate(M, glm::vec3(-1.5f, 1.5f, -5.0f));
        Cube01Shader.use();
        Cube01Shader.setMat4("M", M);
        Cube.Draw(Cube01Shader);

        M = glm::mat4(1.0f);
        M = glm::translate(M, glm::vec3(1.5f, 1.5f, -5.0f));
        Cube02Shader.use();
        Cube02Shader.setMat4("M", M);
        Cube.Draw(Cube02Shader);

        M = glm::mat4(1.0f);
        M = glm::translate(M, glm::vec3(-1.5f, -1.5f, -5.0f));
        Cube03Shader.use();
        Cube03Shader.setMat4("M", M);
        Cube.Draw(Cube03Shader);

        M = glm::mat4(1.0f);
        M = glm::translate(M, glm::vec3(1.5f, -1.5f, -5.0f));
        Cube04Shader.use();
        Cube04Shader.setMat4("M", M);
        Cube.Draw(Cube04Shader);
