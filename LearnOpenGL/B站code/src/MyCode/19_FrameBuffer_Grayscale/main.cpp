...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/19_FrameBuffer_Grayscale/ObjectShader.vert", "./src/MyCode/19_FrameBuffer_Grayscale/ObjectShader.frag");
    Shader OutlineShader("./src/MyCode/19_FrameBuffer_Grayscale/Outline.vert", "./src/MyCode/19_FrameBuffer_Grayscale/Outline.frag");
    Shader WindowShader("./src/MyCode/19_FrameBuffer_Grayscale/Outline.vert", "./src/MyCode/19_FrameBuffer_Grayscale/Window.frag");
    Shader ScreenTextureShader("./src/MyCode/19_FrameBuffer_Grayscale/ScreenTexture.vert", "./src/MyCode/19_FrameBuffer_Grayscale/ScreenTexture.frag");
