...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/19_FrameBuffer_Kernel_Sharpen/ObjectShader.vert", "./src/MyCode/19_FrameBuffer_Kernel_Sharpen/ObjectShader.frag");
    Shader OutlineShader("./src/MyCode/19_FrameBuffer_Kernel_Sharpen/Outline.vert", "./src/MyCode/19_FrameBuffer_Kernel_Sharpen/Outline.frag");
    Shader WindowShader("./src/MyCode/19_FrameBuffer_Kernel_Sharpen/Outline.vert", "./src/MyCode/19_FrameBuffer_Kernel_Sharpen/Window.frag");
    Shader ScreenTextureShader("./src/MyCode/19_FrameBuffer_Kernel_Sharpen/ScreenTexture.vert", "./src/MyCode/19_FrameBuffer_Kernel_Sharpen/ScreenTexture.frag");
