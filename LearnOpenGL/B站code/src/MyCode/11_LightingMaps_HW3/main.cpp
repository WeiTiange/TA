...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/11_LightingMaps_HW3/ObjectShader.vert", "./src/MyCode/11_LightingMaps_HW3/ObjectShader.frag");
    Shader LightShader("./src/MyCode/11_LightingMaps_HW3/LightShader.vert", "./src/MyCode/11_LightingMaps_HW3/LightShader.frag");
    ...
    unsigned int T_container_Emission = loadTexture("Assets/T_container_Emission.jpg");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ObjectShader.setFloat("material.emissionInt", 1.0f);
        ...
        glBindTexture(GL_TEXTURE_2D, T_container_Emission);
        // Model矩阵构建
