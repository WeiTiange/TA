...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/19_FrameBuffer_Inversion/ObjectShader.vert", "./src/MyCode/19_FrameBuffer_Inversion/ObjectShader.frag");
    Shader OutlineShader("./src/MyCode/19_FrameBuffer_Inversion/Outline.vert", "./src/MyCode/19_FrameBuffer_Inversion/Outline.frag");
    Shader WindowShader("./src/MyCode/19_FrameBuffer_Inversion/Outline.vert", "./src/MyCode/19_FrameBuffer_Inversion/Window.frag");
    Shader ScreenTextureShader("./src/MyCode/19_FrameBuffer_Inversion/ScreenTexture.vert", "./src/MyCode/19_FrameBuffer_Inversion/ScreenTexture.frag");
