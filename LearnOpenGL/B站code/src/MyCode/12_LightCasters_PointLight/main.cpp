...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/12_LightCasters_PointLight/ObjectShader.vert", "./src/MyCode/12_LightCasters_PointLight/ObjectShader.frag");
    Shader LightShader("./src/MyCode/12_LightCasters_PointLight/LightShader.vert", "./src/MyCode/12_LightCasters_PointLight/LightShader.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ObjectShader.setVec3("light.position", -0.2f, -1.0f, -0.3f);
        ObjectShader.setVec4("light.lightVector", -0.2f, -1.0f, -0.3f, 1.0f);
        ObjectShader.setVec3("light.ambientInt", 0.2f, 0.2f, 0.2f);
