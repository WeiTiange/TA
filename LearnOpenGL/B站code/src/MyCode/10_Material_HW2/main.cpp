...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/10_Material_HW2/ObjectShader.vert", "./src/MyCode/10_Material_HW2/ObjectShader.frag");
    Shader LightShader("./src/MyCode/10_Material_HW2/LightShader.vert", "./src/MyCode/10_Material_HW2/LightShader.frag");
    ...
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void *)(3 * sizeof(float))); // 发现方向
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ObjectShader.setVec3("material.ambient", 0.0215f, 0.1745f, 0.0215f);
        ObjectShader.setVec3("material.diffuse", 0.07568f, 0.61424f, 0.07568f);
        ObjectShader.setVec3("material.specular", 0.633f, 0.727811f, 0.633f);
        ...
        ObjectShader.setVec3("light.diffuse", 1.0f, 1.0f, 1.0f); // 将光照调暗了一些以搭配场景
