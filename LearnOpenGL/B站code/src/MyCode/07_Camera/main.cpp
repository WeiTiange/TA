...
float lastX = scrWidth/2.0f, lastY = scrHeight/2.0f;
...
//  ---- Texture2----
    ...
    // 创建和编译自定义的shader程序
    Shader customShader("./src/MyCode/07_Camera/3.3.shader.vert", "./src/MyCode/07_Camera/3.3.shader.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        P = glm::perspective(glm::radians(fov), (float)scrWidth / (float)scrHeight, 0.1f, 100.0f);
