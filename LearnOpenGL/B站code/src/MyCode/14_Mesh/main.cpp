...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/14_Mesh/ObjectShader.vert", "./src/MyCode/14_Mesh/ObjectShader.frag");
    
    // -----加载模型-----
    Model customModel("./Assets/Mesh/paimeng/paimeng.obj");
