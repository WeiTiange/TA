...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/19_FrameBuffer_Kernel_Blur/ObjectShader.vert", "./src/MyCode/19_FrameBuffer_Kernel_Blur/ObjectShader.frag");
    Shader OutlineShader("./src/MyCode/19_FrameBuffer_Kernel_Blur/Outline.vert", "./src/MyCode/19_FrameBuffer_Kernel_Blur/Outline.frag");
    Shader WindowShader("./src/MyCode/19_FrameBuffer_Kernel_Blur/Outline.vert", "./src/MyCode/19_FrameBuffer_Kernel_Blur/Window.frag");
    Shader ScreenTextureShader("./src/MyCode/19_FrameBuffer_Kernel_Blur/ScreenTexture.vert", "./src/MyCode/19_FrameBuffer_Kernel_Blur/ScreenTexture.frag");
