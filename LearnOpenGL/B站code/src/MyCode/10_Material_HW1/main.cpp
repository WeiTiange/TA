...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/10_Material_HW1/ObjectShader.vert", "./src/MyCode/10_Material_HW1/ObjectShader.frag");
    Shader LightShader("./src/MyCode/10_Material_HW1/LightShader.vert", "./src/MyCode/10_Material_HW1/LightShader.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ObjectShader.use();
        glm::vec3 lightCol;
        lightCol.x = sin(glfwGetTime() * 2.0f);
        lightCol.y = sin(glfwGetTime() * 0.7f);
        ...
        ObjectShader.setVec3("light.ambient", ambientCol);
        ObjectShader.setVec3("light.diffuse", diffuseCol); // 将光照调暗了一些以搭配场景
