...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/15_DepthTest/ObjectShader.vert", "./src/MyCode/15_DepthTest/ObjectShader.frag");
    
    // -----加载模型-----
    Model testCube("./Assets/Mesh/TestScene/test_cube.obj");
    Model testFloor("./Assets/Mesh/TestScene/test_floor.obj");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        testCube.Draw(ObjectShader);
        testFloor.Draw(ObjectShader);
