...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/12_LightCasters_SpotLight/ObjectShader.vert", "./src/MyCode/12_LightCasters_SpotLight/ObjectShader.frag");
    Shader LightShader("./src/MyCode/12_LightCasters_SpotLight/LightShader.vert", "./src/MyCode/12_LightCasters_SpotLight/LightShader.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ObjectShader.setFloat("light.innerCutOffAngle", glm::cos(glm::radians(12.5f)));
        ObjectShader.setFloat("light.outerCutOffAngle", glm::cos(glm::radians(15.0f)));
        ObjectShader.setVec3("light.ambientInt", 0.1f, 0.1f, 0.1f);
        ObjectShader.setVec3("light.diffuseInt", 0.5f, 0.5f, 0.5f); // 将光照调暗了一些以搭配场景
        ObjectShader.setVec3("light.specularInt", 1.0f, 1.0f, 1.0f);
        ObjectShader.setFloat("light.Kc", 1.0f);    // 覆盖50距离的点光源
