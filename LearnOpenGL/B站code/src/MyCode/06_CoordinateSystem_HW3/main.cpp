...
//  ---- Texture2----
    ...
    // 创建和编译自定义的shader程序
    Shader customShader("./src/MyCode/06_CoordinateSystem_HW3/3.3.shader.vert", "./src/MyCode/06_CoordinateSystem_HW3/3.3.shader.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++) {
            ...
            M = glm::rotate(M, glm::radians(angle), cubeRotateAxes[i]);
