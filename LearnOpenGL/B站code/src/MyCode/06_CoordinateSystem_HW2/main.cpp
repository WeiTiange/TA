...
// 答：V = glm::translate(V, glm::vec3(0.0f, 0.0f, -3.0f)); 物体会远离摄像机
//    V = glm::translate(V, glm::vec3(0.0f, 3.0f, -3.0f)); 物体会向上移动(-3.0f向下)
//    V = glm::translate(V, glm::vec3(3.0f, 0.0f, -3.0f)); 物体会向右移动(-3.0f向左)
...
//  ---- Texture2----
    ...
    // 创建和编译自定义的shader程序
    Shader customShader("./src/MyCode/06_CoordinateSystem_HW2/3.3.shader.vert", "./src/MyCode/06_CoordinateSystem_HW2/3.3.shader.frag");
