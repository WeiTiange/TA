// Basic Lighting 练习1
// 尝试使用sin或cos函数让光源在场景中来回移动。观察光照随时间的改变能让你更容易理解冯氏光照模型
...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/09_BasicLighting_HW1/ObjectShader.vert", "./src/MyCode/09_BasicLighting_HW1/ObjectShader.frag");
    Shader LightShader("./src/MyCode/09_BasicLighting_HW1/LightShader.vert", "./src/MyCode/09_BasicLighting_HW1/LightShader.frag");
