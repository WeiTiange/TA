// LightingMaps练习1
// 尝试在片段着色器中反转镜面光贴图的颜色值，让木头显示镜面高光而钢制边缘不反光
...
int main() {
    ...
    // -----创建和编译Shader-----
    Shader ObjectShader("./src/MyCode/11_LightingMaps_HW1/ObjectShader.vert", "./src/MyCode/11_LightingMaps_HW1/ObjectShader.frag");
    Shader LightShader("./src/MyCode/11_LightingMaps_HW1/LightShader.vert", "./src/MyCode/11_LightingMaps_HW1/LightShader.frag");
